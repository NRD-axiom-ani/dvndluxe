...
export default function Home() {
  ...
  useEffect(() => {
    ...
    el.innerHTML = lines.map((line, li) =>
      `<span class="split-line${line.italic ? " split-italic" : ""}">${
        ...
        <section className="hero" aria-label="DVND hero">
          ...
          <div className="hero-content">
            ...
            <h1
              ...
              id="hero-split"
              aria-label="Two Forces. One Label."
            >
          ...
          <div className="philosophy">
            ...
            <div className="philosophy-visual reveal reveal-delay-1" aria-label="DVND brand visual">
              <Image
                ...
                fill
                sizes="(max-width: 580px) 100vw, (max-width: 900px) 100vw, 50vw"
